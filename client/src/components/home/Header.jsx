    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-8 text-sm">
                ...
                {isLoggedIn && current?.plan !== "pro" && (
                    <Link
                        to="/pricing"
                        className="px-5 py-1.5 rounded-full bg-linear-to-r from-[#01A989] to-[#016A5E] 
                            text-white font-semibold text-base shadow-md hover:opacity-90 transition cursor-pointer"
                    >
                        Nâng cấp Pro
                    </Link>
                )}
